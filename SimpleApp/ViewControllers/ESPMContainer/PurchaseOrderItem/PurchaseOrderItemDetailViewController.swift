...
class PurchaseOrderItemDetailViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private func cellForCurrencyCode(tableView: UITableView, indexPath: IndexPath, currentEntity: ESPMContainerFmwk.PurchaseOrderItem, property: Property) -> UITableViewCell {
        var value = ""
    ...
    func createEntityWithDefaultValues() -> ESPMContainerFmwk.PurchaseOrderItem {
        let newEntity = ESPMContainerFmwk.PurchaseOrderItem()
...
extension PurchaseOrderItemDetailViewController: ESPMContainerEntityUpdaterDelegate {
    func entityHasChanged(_ entityValue: EntityValue?) {
        if let entity = entityValue {
            let currentEntity = entity as! ESPMContainerFmwk.PurchaseOrderItem
